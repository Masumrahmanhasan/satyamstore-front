...
$("#Phone_Register").on('submit',(function(e) {
...
document.getElementById('regtoast').innerHTML = ('<font size="2" style="color:#f00;">Mobile Number allready register with us !</font>');
	...
	function mobileveryfication2(){
var mobile = $('input#opassword').val();
if ((opassword)== "") {
            $("input#opassword").focus();
			$('#opassword').addClass('borderline');
            return false;
			}
if (opassword.length<10) {
            $("input#opassword").focus();
			$('#opassword').addClass('borderline');
            return false;
			}
