...
//==============================change password end====================================================================
$("#changewdpasswordform").on('submit',(function(e) {
e.preventDefault();

var mobile = $('input#moble').val();
// var npassword = $('input#npassword').val();
var cpassword = $('input#cpassword').val();
...
if ((cpassword)== "") {
	...
	$('#alert2').modal({backdrop: 'static', keyboard: false})  
	 ...
	 document.getElementById('alertmessage2').innerHTML = "<h4>Success !</h4><p>Password change successfully !</p>";
		...
		$('#alert').modal({backdrop: 'static', keyboard: false})  
     $('#alert').modal('show');
	 document.getElementById('alertmessage').innerHTML = "<h4>Fail !</h4><p>Something went wrong. Please try again later!</p>";
            return false;
